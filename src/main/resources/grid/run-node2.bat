...
set NODE_CONFIG=C:\Users\ylyzohubov\Downloads\testframework\src\main\resources\grid\configurations/node2-config.json
set CHROME_DRIVER=C:\Users\ylyzohubov\Downloads\testframework\src\main\resources\grid\drivers\chromedriver.exe
set FIREFOX_DRIVER=C:\Users\ylyzohubov\Downloads\testframework\main\resources\grid\drivers\geckodriver.exe
set IE_DRIVER=C:\Users\ylyzohubov\Downloads\testframework\src\main\resources\grid\drivers\IEDriverServer.exe
